...
class Pipeline:
    def __init__(self, sport_name: str, video_path: str):
    ...
    def run(self) -> None:
        ...
        try:
            for frame in self.video_source.iter_frames():
                ...
                for det in tracked_detections:
                    ...
                    if det.track_id not in self.match_data.players:
                        ...
                        self.match_data.players[det.track_id] = Player(
                            track_id=det.track_id, team_id=team_id
                        )
                    # Update positions
...
def main() -> None:
    ...
    parser.add_argument("--sport", type=str, required=True, help="Sport config (football, rugby, basketball)")
